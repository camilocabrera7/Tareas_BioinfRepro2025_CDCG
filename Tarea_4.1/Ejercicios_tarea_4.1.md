...
## Conclusiones
A pesar de utilizar un subconjunto aleatorio de solo 5,000 sondas (aprox. 20% del total), el análisis de control de calidad y los patrones de expresión diferencial lograron replicar las tendencias biológicas reportadas en el estudio original (Llamas et al., 2009). Esto sugiere que el efecto del Cromosoma Y y su interacción con la testosterona (tratamiento de castración) induce una remodelación transcriptómica global en el tejido cardíaco, lo suficientemente potente para ser detectada incluso con una fracción reducida del transcriptoma. El análisis de los diagramas de Venn y los contrastes de interacción confirma que las diferencias transcriptómicas entre las cepas (C57BL/6J vs. Consómica Y) son mínimas en condiciones basales (animales intactos), pero se exacerban significativamente bajo estrés hormonal (castración). 
