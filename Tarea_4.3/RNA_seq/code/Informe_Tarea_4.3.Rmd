...
- **Magnitud del Cambio:** Se observaron genes con valores de $|log_2FC|$ significativamente elevados. La presencia de genes con cambios de expresión tan marcados sugiere una respuesta biológica robusta ante la transición al estado sésil (biopelícula).
...
2. **Distribución:** Mientras la mayoría de los genes mantienen una expresión basal (cerca de la diagonal), un subconjunto claro se desplaza significativamente, indicando una inducción (puntos sobre la diagonal) o represión (puntos bajo la diagonal) específica en biopelícula.
...
- **Evidencia Estadística Débil:** Tras excluir los genes afectados por el medio de cultivo, los genes restantes mostraron valores de $logFC$ de menor magnitud y valores de $FDR$ menos competitivos.
